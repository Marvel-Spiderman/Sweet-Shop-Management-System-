    ...
    if (orderSuccess) {
        return (
            <motion.div
                ...
                className="max-w-2xl mx-auto px-4 pt-32 pb-16 text-center"
            >
                <h2 className="text-3xl font-bold text-green-600 mb-4">
                    Order Placed Successfully!
                </h2>
                <p className="text-gray-600 mb-8">
                    Thank you for ordering with Incubyte Sweets.
                </p>
                <Link
                    to="/"
                    className="inline-block bg-blue-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-blue-700 transition shadow-lg"
                >
                    Continue Shopping
                </Link>
            </motion.div>
