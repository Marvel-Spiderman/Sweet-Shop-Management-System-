    ...
    if (orderSuccess) {
        return (
            <div className="max-w-2xl mx-auto px-4 py-16 text-center">
                ...
                <Link to="/" className="inline-block bg-primary text-white px-6 py-3 rounded-lg font-medium hover:bg-blue-900 transition">
                    Continue Shopping
                </Link>
            </div>
        );
    ...
    if (cart.length === 0) {
        return (
            <div className="max-w-7xl mx-auto px-4 py-16 text-center">
                ...
                <Link to="/shop" className="inline-block bg-primary text-white px-6 py-3 rounded-lg font-medium hover:bg-blue-900 transition">
                    Browse Sweets
                </Link>
            </div>
        );
                        ...
                        <div key={item.id} className="bg-white p-4 rounded-xl shadow-sm flex gap-4 items-center">
                            ...
                            <div className="text-right min-w-[80px]">
                                ...
                                <button
                                    ...
                                    className="text-red-500 text-sm hover:underline flex items-center justify-end gap-1 mt-1"
                                >
                ...
                <div className="lg:col-span-1">
                    <div className="bg-white p-6 rounded-xl shadow-md sticky top-24">
                        ...
                        <button
                            ...
                            className="w-full bg-accent text-white py-3 rounded-lg font-bold hover:bg-yellow-500 transition flex justify-center disabled:opacity-50"
                        >
